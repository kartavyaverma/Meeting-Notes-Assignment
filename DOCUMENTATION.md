...
|---|---|---|---|---|
| BrightPath kickoff (4 people) | ~5 min, ~1,000 words | 2,324 | 1,164 | 0 |
| Ridgeline discovery (2 people) | ~2 min, ~400 words | 1,011 | 467 | 0 |
...
Two transcripts is a small sample, so "no misattributions yet" isn't "never". That's the whole point of the second safeguard: it doesn't depend on the model being right (see *How it works*, step 5).
